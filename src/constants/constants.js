...
export const themeParams = [
    {
        ...
        navBarClass: 'navbar navbar-expand navbar-dark bg-space-black',
        ...
        redoButtonClass: 'btn btn-sm btn-outline-warning',
        inputClass: 'form-control form-control-sm mx-1 w-25 text-input-space-black',
        mobileInputClass: 'form-control form-control-sm text-input-space-black'
    },
    {
        themeType: 'light',
        sceneBackgroundClass: 'p-2 bg-soap-bubble',
        navBarClass: 'navbar navbar-expand navbar-light bg-soap-bubble',
        ...
        redoButtonClass: 'btn btn-sm btn-warning',
        inputClass: 'form-control form-control-sm mx-1 w-25',
        mobileInputClass: 'form-control form-control-sm'
    },
    {
        themeType: 'dark',
        sceneBackgroundClass: 'p-2 bg-deep-ocean',
        navBarClass: 'navbar navbar-expand navbar-dark bg-deep-ocean',
        ...
        redoButtonClass: 'btn btn-sm flare-orange-reverse',
        inputClass: 'form-control form-control-sm mx-1 w-25',
        mobileInputClass: 'form-control form-control-sm'
    },
    {
        ...
        navBarClass: 'navbar navbar-expand navbar-light bg-light',
        ...
        redoButtonClass: 'btn btn-sm sun-core',
        inputClass: 'form-control form-control-sm mx-1 w-25',
        mobileInputClass: 'form-control form-control-sm'
    },
    {
        ...
        redoButtonClass: 'btn btn-sm btn-outline-warning text-dark',
        inputClass: 'form-control form-control-sm mx-1 w-25',
        mobileInputClass: 'form-control form-control-sm'
    },
    {
        ...
        navBarClass: 'navbar navbar-expand navbar-dark bg-midnight',
        ...
        redoButtonClass: 'btn btn-sm fire-laser',
        inputClass: 'form-control form-control-sm text-input-underlined ml-1 mr-2 w-25',
        mobileInputClass: 'form-control form-control-sm text-input-underlined'
    }
];
